...
## V3 桌面启动器更新（2026-08-09）

- 桌面 `GPT 无限画布.lnk` 已更新为 V3 0.4.0 启动器。
- 原快捷方式备份为 `GPT 无限画布.backup-20260809-024301.lnk`。
- 启动器增加运行服务版本核对、活动任务保护和受控旧进程刷新。
- 安装后桥接服务 PID 由旧进程刷新，`/health` 返回 `releaseVersion: 0.4.0`。

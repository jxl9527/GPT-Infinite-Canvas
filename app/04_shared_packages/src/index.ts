...
export const STATUS_TRANSITIONS: Readonly<Record<GenerationStatus, readonly GenerationStatus[]>> = {
  ...
  submitted: ["generating", "collecting", "needs-user", "failed"],
  generating: ["collecting", "needs-user", "failed"],
  collecting: ["returning", "completed", "needs-user", "failed"],
  returning: ["completed", "needs-user", "failed"],
